...
[![Teams](https://img.shields.io/badge/teams-148-2563eb?style=flat-square)](https://goya4140.github.io/awesome-team/)
[![Institutions](https://img.shields.io/badge/institutions-47-2563eb?style=flat-square)](docs/SEED_LIST.md)
[![Verified](https://img.shields.io/badge/verified-127-2563eb?style=flat-square)](docs/TEAM_COLLECTION_METHOD.md)
[![Resolved papers](https://img.shields.io/badge/resolved_papers-166-2563eb?style=flat-square)](docs/RESEARCH_TEAMS.md)
[![Method figures](https://img.shields.io/badge/method_figures-117-2563eb?style=flat-square)](docs/RESEARCH_TEAMS.md)
...
| 前沿 AI 公司 / 研究机构 | 7 | 15 | OpenAI、Anthropic、中国前沿模型公司与上海 AI Lab |
| 顶尖高校 | 23 | 89 | C9、HKUST(GZ)、港三、新二、美国 AI 核心高校 |
| **合计** | **47** | **148** | **127 verified / 21 provisional** |

地区分布：**中国大陆 70**、**美国 58**、**中国香港 11**、**新加坡 9**。
...
| 文件 | 用途 |
|---|---|
| [`data/seed-parents.yaml`](data/seed-parents.yaml) | 47 个母体机构白名单 |
| [`data/research-teams.yaml`](data/research-teams.yaml) | 148 个团队的主数据与证据 |
